...
import com.example.youtube.databinding.ItemMangaBinding

class MangaAdapter(private val onClickListener: (id: String) -> Unit): PagingDataAdapter<DataItem, MangaAdapter.MangeViewHolder>(
    diffUtil
) {
